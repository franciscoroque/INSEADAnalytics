...
### Part I: Statistics of Apple Daily Returns

We have `r nrow(StockReturns)` days of data, starting from `r rownames(StockReturns)[1]` until `r tail(rownames(StockReturns),1)`.  Here are some basic statistics about the Apple returns:
...
2. The standard deviation of the daily returns of the Apple index during this period is `r round(100*sd(StockReturns[,2]),3)`%;
...
**Your Answers here:**
<br> 1) It is in dataSet1.R in line 8 "mytickers = c("SPY", "AAPL")"
<br> 2) 597.2%, 0.148% and 2.388%
<br> 3) Yes, using Yahoo's ticker YHOO in dataSet1.R in line 8 mytickers = c("SPY", "AAPL", "YHOO") and then changing in ExerciseSet1.Rmd lines 72, 73 and 74 "StockReturns[,2]" to "StockReturns[,3]
<br>
...
**Your Answers here:**
<br>1) In line 9 change to 2000-12-31 in order to have the return of 2001-01-01
<br>2) Yes, by adding new tickers and use the function t to create a matrix including specific dates of stockreturns and then use apply function 
<br>
<br>
...
**Your Answers here:**
<br>1) It returns 20
<br>2) There is an error because the formats are different
<br>
<br>
