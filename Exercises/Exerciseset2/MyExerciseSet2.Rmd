...
*1) 6
<br>2) 0.93
<br>3) Comp1: Bonds; Comp2: Currencies; Comp3: European stocks; Comp4: North America stocks; Comp5: European interest rates; Comp6: Oil prices; Comp7: Basic Metals prices; Comp8: Food commodity prices; Comp9: Precious metals prices; Comp10: Asian stock markets.
<br>4) For pre crisis
```{r echo=TRUE}
...
<br> 5) In pre crisis there are more components with Eigen value above 1
*
*
*
*
...
*<br> 1) It creates matrix of moving averages indicating if the future's return was positive or negative. 
<br> Changing MAfreq<-seq(10,250,by=20) chenges the frequency of trading strategy being implemented, dependent on the moving average. 
*
*
*
*
